...
if($_SERVER['REQUEST_URI'] == "/_mailbox.php"){
exit();
}
...
echo "Your mailbox has been cleaned.";
} // if clean
...
if($newmail == "0"){
$result = mysql_query("UPDATE login SET newmail='1' WHERE id='".mysql_real_escape_string($_SESSION['user_id'])."'")
or die(mysql_error());
